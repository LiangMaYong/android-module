 ...
 * @version 1.0
 */
public class AMBadgeView extends TextView {

	private boolean mHideOnNull = true;

	public AMBadgeView(Context context) {
		this(context, null);
	}

	public AMBadgeView(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.textViewStyle);
	}

	public AMBadgeView(Context context, AttributeSet attrs, int defStyle) {
