...
public class AMSwitchButton extends CompoundButton {
	...
	public static final int DEFAULT_TINT_COLOR = 0xff15a560;
	...
	public AMSwitchButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(attrs);
	}

	public AMSwitchButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}

	public AMSwitchButton(Context context) {
		super(context);
		init(null);
	}
	...
	/**
	 * Generate thumb and background color state list use tintColor Created by
	 * kyle on 15/11/4.
	 */
	public static class ColorUtils {
		...
		public static ColorStateList generateThumbColorWithTintColor(final int tintColor) {
			...
			int[] colors = new int[] { tintColor - 0xAA000000, 0xFFEEEEEE, 0xFFEEEEEE, 0xFFEEEEEE, 0xFFEEEEEE,
					0xFFEEEEEE };
		...
		public static ColorStateList generateBackColorWithTintColor(final int tintColor) {
			...
			int[] colors = new int[] { tintColor - 0x00000000, 0x00000000, tintColor - 0x00000000, 0x20000000,
					tintColor - 0x00000000/* pre */, 0x20000000 /* back */ };
			return new ColorStateList(states, colors);
		}
	}
}