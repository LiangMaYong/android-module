 ...
 * @version 1.0
 */
public class AMRippleButton extends AMButton {
	...
	public AMRippleButton(Context context) {
		super(context);
	}

	public AMRippleButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public AMRippleButton(Context context, AttributeSet attrs, int defStyleAttr) {
