package com.androidmodule.view.drawable;
 ...
 * @version 1.0
 */
public class AMRadiusDrawable extends Drawable {
	...
	public AMRadiusDrawable(int topLeftRadius, int topRightRadius, int bottomLeftRadius, int bottomRightRadius,
	...
	public AMRadiusDrawable(int radius, boolean isStroke, int color) {
