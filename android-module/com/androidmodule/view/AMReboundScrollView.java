 ...
 */
public class AMReboundScrollView extends FrameLayout implements OnTouchListener {
	...
	public AMReboundScrollView(Context context) {
		this(context, null);
	}

	public AMReboundScrollView(Context context, AttributeSet attrs) {

		this(context, attrs, 0);
	}

	public AMReboundScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	public static interface OnScrollChangedListener {
		void onScrollChanged(int leftOfVisibleView, int topOfVisibleView, int oldLeftOfVisibleView,
				int oldTopOfVisibleView);
	}

	private OnScrollChangedListener changedListener;

	public void setOnScrollChangedListener(OnScrollChangedListener changedListener) {
	...
	protected void onScrollChanged(int leftOfVisibleView, int topOfVisibleView, int oldLeftOfVisibleView,
		...
		if (changedListener != null) {
			changedListener.onScrollChanged(leftOfVisibleView, topOfVisibleView - 1500, oldLeftOfVisibleView,
					oldTopOfVisibleView);
		}
