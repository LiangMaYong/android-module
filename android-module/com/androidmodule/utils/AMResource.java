...
public class AMResource {
	...
	private AMResource(Context context) {
	}
	 ...
	 */
	public static ColorStateList getColorStateList(int color, int pressed) {
	 ...
	 * @return ColorStateList
	 */
	public static ColorStateList getColorStateList(int color, int pressed, int focesed) {
		int statePressed = android.R.attr.state_pressed;
		int stateFocesed = android.R.attr.state_focused;
		int[][] state = { { statePressed }, { -statePressed }, { stateFocesed }, { -stateFocesed } };
		ColorStateList colors = new ColorStateList(state, new int[] { pressed, color, focesed, color });
		return colors;
	}
